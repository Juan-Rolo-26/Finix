...
export const SPECIAL_ASSET_LOGOS: Record<string, string[]> = {
    ...
    'SI1!': ['https://s3-symbol-logo.tradingview.com/silver--big.svg'],
    'ZC1!': ['https://s3-symbol-logo.tradingview.com/corn--big.svg'],
    'CL1!': ['https://s3-symbol-logo.tradingview.com/crude-oil--big.svg'],
    SPX: ['https://s3-symbol-logo.tradingview.com/sp--big.svg'],
