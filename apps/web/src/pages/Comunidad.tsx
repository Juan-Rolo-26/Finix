                    ...
                    {MEDIA_FILTERS.map(f => {
                        ...
                        return (
                            <button
                                ...
                                className={`flex shrink-0 items-center gap-1.5 rounded-full px-3 py-1.5 text-sm font-medium transition-colors ${active
                    ...
                    >
                        <div className="px-4 py-4 space-y-3 max-w-2xl mx-auto">
                            ...
                            <div className="space-y-1">
                                <label className="text-sm text-muted-foreground">URL del recurso *</label>
                                <input
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                ...
                                <div className="space-y-1">
                                    <label className="text-sm text-muted-foreground">Tipo de media</label>
                                    <select
                            ...
                            <div className="grid grid-cols-3 gap-2">
                                ...
                                <div className="space-y-1">
                                    <label className="text-sm text-muted-foreground">Duración (opcional)</label>
                                    <input
                                        className="w-full rounded-lg bg-muted px-3 py-2 text-sm outline-none focus:ring-1 focus:ring-primary placeholder:text-muted-foreground/60"
                                ...
                                <div className="space-y-1">
                                    <label className="text-sm text-muted-foreground">Thumbnail URL</label>
                                    <input
                                        className="w-full rounded-lg bg-muted px-3 py-2 text-sm outline-none focus:ring-1 focus:ring-primary placeholder:text-muted-foreground/60"
                                        placeholder="https://..."
                            ...
                            {(form.thumbnailUrl || autoThumbnail(form.url)) && (
                                <div className="flex items-center gap-2">
                                    ...
                                    />
                                    <p className="text-sm text-muted-foreground">Vista previa del thumbnail</p>
                                </div>
                            )}
                ...
                {ytId && !isMine && (
                    <div className="mt-1 w-full max-w-xs rounded-xl overflow-hidden border border-border">
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center gap-2 bg-muted px-3 py-2 text-sm hover:bg-muted/80 transition-colors"
                        >
        ...
        >
            ...
            <div className="flex items-start gap-3">
                <Avatar className="h-9 w-9 shrink-0">
                    ...
                    <AvatarFallback className="text-sm">{post.author.username[0]?.toUpperCase()}</AvatarFallback>
                </Avatar>
                <div className="flex-1 min-w-0">
                    <div className="flex flex-wrap items-center gap-2 mb-1">
                        ...
                        {post.channel && (
                            <span className="text-sm text-muted-foreground">{post.channel.icon} {post.channel.name}</span>
                        )}
                        <span className="text-sm text-muted-foreground/50 ml-auto">{fmtDate(post.createdAt)}</span>
                    </div>
                    {post.title && <h3 className="font-semibold text-sm mb-1">{post.title}</h3>}
                    <p className="text-[15px] text-foreground/90 leading-relaxed whitespace-pre-line line-clamp-5">
                        {post.content}
                    </p>
                    {post.mediaUrl && (
                    ...
                    {ytId && !post.mediaUrl && (
                        <div className="mt-3 rounded-xl overflow-hidden border border-border">
                            ...
                            <div className="bg-muted px-3 py-2 text-sm text-muted-foreground flex items-center gap-1">
                                <Play className="h-3 w-3 text-red-500" /> YouTube
                            </div>
                        </div>
                    )}
                    <div className="mt-3 flex items-center gap-3">
                        <button onClick={() => onSelect(post)} className="flex items-center gap-1.5 text-sm text-muted-foreground hover:text-primary transition-colors">
                            <MessageSquare className="h-3.5 w-3.5" />
                            {post._count?.comments ?? 0} comentarios
                        </button>
                        {canPin && (
                            <button onClick={() => onPin(post.id, !post.isPinned)} className="flex items-center gap-1 text-sm text-muted-foreground hover:text-primary transition-colors">
                                <Pin className="h-3.5 w-3.5" />
                                {post.isPinned ? 'Desfijar' : 'Fijar'}
                            </button>
                        )}
                        {canDelete && (
                            <button onClick={() => onDelete(post.id)} className="flex items-center gap-1 text-sm text-destructive/70 hover:text-destructive transition-colors ml-auto">
                ...
                <div className="p-5 space-y-4">
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <div className="flex items-center gap-2 mb-1">
                                ...
                                <AuthorBadge role={post.author.role} />
                                <span className="text-sm text-muted-foreground">{fmtDate(post.createdAt)}</span>
                            </div>
                            {post.title && <h2 className="font-bold text-sm mb-2">{post.title}</h2>}
                    ...
                    <div>
                        ...
                        <div className="space-y-3">
                            ...
                            {comments.length === 0 && <p className="text-sm text-muted-foreground text-center py-4">Sé el primero en comentar</p>}
                        </div>
                    </div>
        ...
        <div className="flex-1 overflow-y-auto">
            <div className="mx-auto max-w-2xl px-4 py-4 space-y-4">
                ...
                {Object.entries(grouped).map(([month, evs]) => (
                    <div key={month}>
                        <p className="text-sm font-semibold uppercase tracking-widest text-muted-foreground/50 mb-3 capitalize">{month}</p>
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="flex items-start justify-between gap-2">
                                                    <div>
                                                        ...
                                                        {ev.description && <p className="text-sm text-foreground/70 mt-1">{ev.description}</p>}
                                                    </div>
                                                    {isAdmin(currentUserRole) && (
                                                ...
                                                {ev.link && (
                                                    <a href={ev.link} target="_blank" rel="noopener noreferrer"
                                                        className="mt-2 inline-flex items-center gap-1.5 rounded-lg bg-primary/10 px-3 py-1.5 text-sm font-medium text-primary hover:bg-primary/20 transition-colors"
                                                    >
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <button onClick={() => setAdminTab('channels')} className="rounded-xl border border-border bg-card p-4 text-left hover:border-primary/40 transition-colors group">
                                ...
                                <p className="text-sm text-muted-foreground mt-0.5">Crear, editar y eliminar canales</p>
                            </button>
                            <button onClick={() => setAdminTab('posts')} className="rounded-xl border border-border bg-card p-4 text-left hover:border-primary/40 transition-colors group">
                                ...
                                <p className="text-sm text-muted-foreground mt-0.5">Fijar y eliminar posts</p>
                            </button>
                            <button onClick={() => setAdminTab('members')} className="rounded-xl border border-border bg-card p-4 text-left hover:border-primary/40 transition-colors group">
                                ...
                                <p className="text-sm text-muted-foreground mt-0.5">{stats?.totalMembers ?? '—'} usuarios registrados</p>
                            </button>
                            <div className="rounded-xl border border-border bg-card p-4">
                                ...
                                <p className="text-sm text-muted-foreground/60 mt-0.5">Gestionarlos desde sus secciones en el sidebar</p>
                            </div>
                        </div>
                    </div>
                )}
                            ...
                            {showCreateChannel && (
                                <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: 'auto', opacity: 1 }} exit={{ height: 0, opacity: 0 }} className="overflow-hidden">
                                    <div className="space-y-2 rounded-xl border border-primary/20 bg-primary/5 p-4">
                                        <p className="text-sm font-semibold text-primary">Nuevo canal</p>
                                        <div className="grid grid-cols-2 gap-2">
                                        ...
                                        <div className="flex justify-end gap-2">
                                            <button onClick={() => setShowCreateChannel(false)} className="px-3 py-1.5 text-sm text-muted-foreground hover:text-foreground">Cancelar</button>
                                            <button onClick={createChannel} disabled={creatingChannel || !channelForm.slug || !channelForm.name} className="rounded-lg bg-primary px-4 py-1.5 text-sm font-medium text-primary-foreground disabled:opacity-40">
                        ...
                        <div className="space-y-2">
                                ...
                                <div key={ch.id} className="rounded-xl border border-border bg-card overflow-hidden">
                                    {editingChannelId === ch.id ? (
                                        <div className="p-3 space-y-2 bg-muted/30">
                                            ...
                                            <div className="flex justify-end gap-2">
                                                <button onClick={() => setEditingChannelId(null)} className="px-3 py-1 text-sm text-muted-foreground hover:text-foreground">Cancelar</button>
                                                <button onClick={() => saveEditChannel(ch.id)} className="rounded-lg bg-primary px-3 py-1 text-sm font-medium text-primary-foreground">Guardar cambios</button>
                                            </div>
                                        </div>
                                    ) : (
                            ...
                            {channels.length === 0 && (
                                <div className="flex flex-col items-center gap-2 py-12 text-muted-foreground/50">
                                    ...
                                    <button onClick={() => setAdminTab('overview')} className="text-sm text-primary">Ir a Resumen →</button>
                                </div>
                            )}
                        </div>
                    </div>
                ...
                {adminTab === 'posts' && (
                    <div className="space-y-3">
                        <div className="flex items-center gap-2 flex-wrap">
                            ...
                            <span className="text-sm text-muted-foreground">{filteredPosts.length} publicaciones</span>
                                    ...
                                    <div key={post.id} className={`rounded-xl border bg-card p-3 ${post.isPinned ? 'border-primary/30 bg-primary/5' : 'border-border'}`}>
                                        <div className="flex items-start gap-2.5">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <p className="text-sm text-foreground/70 line-clamp-3 leading-relaxed">{post.content}</p>
                ...
                {adminTab === 'members' && (
                    <div className="space-y-3">
                        ...
                        {membersLoading ? (
                            ...
                            <>
                                <p className="text-sm text-muted-foreground">{filteredMembers.length} de {members.length} miembros</p>
            ...
            <div className="flex flex-1 flex-col overflow-hidden">
                ...
                <div className="flex shrink-0 items-center gap-3 border-b border-border bg-background/80 backdrop-blur-sm px-4 py-3">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        {viewDescription() && (
                            <p className="text-sm text-muted-foreground mt-0.5 truncate">{viewDescription()}</p>
                        )}
                    </div>
                    {activeView.type === 'channel' && activeView.channel.type === 'CHAT' && (
                        <span className="text-sm text-muted-foreground/60 flex items-center gap-1 shrink-0">
