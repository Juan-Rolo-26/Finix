...
// ─── Web Analysis prompt (chat libre) ────────────────────────────────────────

export function buildWebAnalysisPrompt(params: {
    query: string;
    context?: string;
...
// ─── Asset web context prompt ─────────────────────────────────────────────────

export function buildAssetWebPrompt(params: {
    ticker: string;
    question?: string;
    searchResults: WebSearchResult[];
}): { system: string; prompt: string } {
